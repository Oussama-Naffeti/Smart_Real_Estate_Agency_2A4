...
int statistique::Statistique_partie2()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from agence where adresse = 'Bizerte'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie3()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from agence where adresse = 'Tunis'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie4()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from agence where adresse = 'Nabeul'") ;
    while(requete.next())
    {
            count++ ;
    }
...
int statistique::Statistique_partie6()
{
    QSqlQuery query;
    int count=0 ;
    QSqlQuery requete("select * from agence where adresse = 'Sousse'") ;
    while(requete.next())
    {
            count++ ;
    }
